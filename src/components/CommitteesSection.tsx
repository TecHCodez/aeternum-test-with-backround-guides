...
import { Scale, Shield, Building2, Camera } from 'lucide-react';
...
const committees = [
  ...
  },
  {
    ...
    icon: Shield,
    image: '/images/committees/disec.jpg',
  ...
  },
  {
    ...
    icon: Building2,
    image: '/images/committees/aippm.jpg',
  ...
  },
  {
    ...
    icon: Camera,
    image: '/images/committees/ip.jpg',
  ...
  return (
    <section id="committees" className="relative py-24 lg:py-32 bg-secondary/30">
              ...
              `}>
                ...
                <div className="absolute inset-0 z-0 opacity-10 group-hover:opacity-20 transition-opacity duration-500">
                  <img 
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&q=80&w=800";
                    }}
                  />
                </div>

                <div className={`relative z-10 p-8 h-full bg-gradient-to-br ${committee.color}`}>
                  {/* Corner accents */}
      ...
      <Dialog open={!!selectedCommittee} onOpenChange={() => setSelectedCommittee(null)}>
        <DialogContent className="bg-card border-border/50 max-w-lg overflow-hidden p-0">
          {selectedCommittee && (
            <>
              <div className="relative h-48 w-full">
                ...
                <div className="absolute bottom-4 left-6">
                  <selectedCommittee.icon className="w-10 h-10 text-primary mb-2" />
              ...
              <div className="p-6 pt-2">
                <DialogHeader>
                  <p className="text-xs font-mono tracking-[0.1em] uppercase text-primary mb-4">
                ...
                <div className="mt-8 pt-4 border-t border-border">
                  <button className="btn-diplomatic w-full text-xs py-3">
                    Express Interest
                  </button>
                </div>
              </div>
